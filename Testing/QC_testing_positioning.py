...
def main():
    ...
    class_name = 'Positioning' #Change this based on different classes
    n_classes = 3
    ...
    model.eval()
    model.load_state_dict(torch.load("./best_metric_model_LISA_LF_" + class_name +".pth", map_location='cuda:0'))
